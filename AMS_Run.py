...
window = tk.Tk()
window.title("Attendance Monitoring System Using Image Processing")
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                cs = 'C:/Users/Srinivas/.spyder-py3/mini/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:\Users\Srinivas\.spyder-py3\mini\Attendance\"')
    ...
    def log_in():
        ...
        if username == 'shruthi' :
            if password == '12345':
                ...
                cs = r"C:\Users\Srinivas\.spyder-py3\mini\StudentDetails\StudentDetails.csv"
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
message = tk.Label(window, text="Attendance Monitoring System Using Image Processing", bg="pink", fg="black", width=50,
