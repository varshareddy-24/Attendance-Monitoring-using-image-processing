...
mainwindow=tk.Tk()
mainwindow.title("Attendance Monitoring System Using Image Processing")
#window = tk.Tk()
        ...
        if username == 'shruthi' :
            if password == '12345':
                ...
                def subjectchoose():
                    ...
                    def Attf():
                        import subprocess
                        subprocess.Popen(r'explorer /select,"C:/Users/Srinivas/.spyder-py3/mini/Attendance/-------Check atttendance-------"')
                ...
                def admin_login():
                        ...
                        def log_in():
                            ...
                            if username == 'shruthi' :
                                if password == '12345':
                                    csvfile=r"C:\Users\Srinivas\.spyder-py3\mini\StudentDetails\StudentDetails.csv"
